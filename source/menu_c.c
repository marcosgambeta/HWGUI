...
HB_FUNC_TRANSLATE(SETMENUITEMBITMAPS, HWG_SETMENUITEMBITMAPS)
HB_FUNC_TRANSLATE(GETMENUCHECKMARKDIMENSIONS, HWG_GETMENUCHECKMARKDIMENSIONS)
HB_FUNC_TRANSLATE(GETSIZEMENUBITMAPWIDTH, HWG_GETMENUBITMAPWIDTH)
HB_FUNC_TRANSLATE(GETSIZEMENUBITMAPHEIGHT, HWG_GETMENUBITMAPHEIGHT)
