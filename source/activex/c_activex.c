/*
 * $Id: c_activex.c 2012 2013-03-07 09:03:56Z alkresin $
 */
/*
 * ooHG source code:
 * ActiveX control
...
// constructor
// params:
// device_interface        - refers to the interface type of the COM object (whose event we are
// trying to receive). device_event_interface  - indicates the interface type of the outgoing
// interface supported by the COM object.
//                           This will be the interface that must be implemented by the Sink object.
//                           is essentially derived from IDispatch, our Sink object (this
//                           IEventHandler) is also derived from IDispatch.
