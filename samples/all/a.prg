...
Private nColor, oBmp2
   ...
   INIT WINDOW oMainWindow MDI TITLE "Example" MENUPOS 3 COLOR HBrush():Add(16744703):color

   @ 0, 0 PANEL oPanel SIZE 0, 32
   @ 2, 3 OWNERBUTTON OF oPanel ON CLICK {||CreateChildWindow()} SIZE 32, 26 FLAT ;
...
Local e5 := 10320.54
   ...
   INIT WINDOW oChildWnd MDICHILD TITLE "Child" STYLE WS_CHILD + WS_OVERLAPPEDWINDOW //STYLE WS_VISIBLE + WS_OVERLAPPEDWINDOW

   @ 0, 0 PANEL oPanel OF oChildWnd SIZE 0, 44

   @ 2, 3 OWNERBUTTON oBoton1 OF oPanel ID 108 ON CLICK {||oBoton2:Enable()} SIZE 44, 38 FLAT ;
       TEXT "New" FONT oFontBtn COORDINATES 0, 20, 0, 0  ;
       BITMAP cImageDir+"new.bmp" COORDINATES 0, 4, 0, 0 TOOLTIP "New"
   @ 46, 3 OWNERBUTTON oBoton2 OF oPanel ID 109 ON CLICK {||oBoton2:disable()} SIZE 44, 38 FLAT ;
       TEXT "Open" FONT oFontBtn COORDINATES 0, 20, 0, 0 ;
       BITMAP cImageDir+"open.bmp" COORDINATES 0, 4, 0, 0 TOOLTIP "Open" DISABLED

   @ 20, 55 GET e1 PICTURE "XXXXXXXXXXXXXXX" SIZE 260, 25

   @ 20, 80 GET e2 SIZE 260, 25

   @ 20, 105 GET e3 SIZE 260, 25

   @ 20, 130 GET e4 PICTURE "@R 99.999.999/9999-99" SIZE 260, 25

   @ 20, 155 GET e5 PICTURE "@e 999,999,999.99" SIZE 260, 25
...
Local oCmd1, oCmd2, oCmd3
   ...
   @ 20, 35 EDITBOX oEdit CAPTION "" STYLE WS_DLGFRAME SIZE 260, 26 COLOR hwg_VColor("FF0000")
   oEdit:anchor := 11
   ...
   @ 20, 240 BUTTONEX oCmd1 CAPTION "Ok" ID IDOK SIZE 100, 32 COLOR hwg_VColor("FF0000")
   @ 140, 240 BUTTONEX oCmd2 CAPTION "11" SIZE 20, 32 ON CLICK {|o|CreateC(o)}
   @ 180, 240 BUTTONEX oCmd3 CAPTION "Cancel" ID IDCANCEL SIZE 100, 32
   oCmd1:Anchor := 4
   oCmd2:Anchor := 4
   oCmd3:Anchor := 4
...
Local oSay
   ...
   INIT DIALOG oModDlg TITLE "About" AT 190, 10 SIZE 360, 240 ICON oIcon FONT oFontDlg ;
   ...
   @ 20, 60 SAY "Sample Dialog" SIZE 130, 22 STYLE SS_CENTER COLOR hwg_VColor("0000FF")

   @ 20, 80 SAY "Written as a sample" SIZE 130, 22 STYLE SS_CENTER
   @ 20, 100 SAY "of Harbour GUI" SIZE 130, 22 STYLE SS_CENTER
   @ 20, 120 SAY "application" SIZE 130, 22 STYLE SS_CENTER

   @ 20, 140 SAY "Hwgui Page" LINK "http://kresin.belgorod.su/hwgui.html" ;
      SIZE 130, 22 STYLE SS_CENTER COLOR hwg_VColor("0000FF") VISITCOLOR hwg_Rgb(241, 249, 91)

   @ 20, 160 SAY "Hwgui international Forum" LINK "http://br.groups.yahoo.com/group/hwguibr" ;
       SIZE 200, 22 STYLE SS_CENTER COLOR hwg_VColor("0000FF") VISITCOLOR hwg_Rgb(241, 249, 91)
...
Local nId
   ...
   IF !Empty(fname)
      ...
      INIT DIALOG oModDlg TITLE "1" AT 210, 10 SIZE 500, 300 ;
