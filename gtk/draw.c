/*
 * $Id: draw.c 2067 2013-06-07 09:39:59Z alkresin $
 *
...
HB_FUNC(HWG_RECTANGLE)
{
  ...
  cairo_rectangle(hDC->cr, (gdouble)x1, (gdouble)y1, (gdouble)(hb_parni(4) - x1 + 1), (gdouble)(hb_parni(5) - y1 + 1));
  cairo_stroke(hDC->cr);
}
...
HB_FUNC(HWG_DRAWBUTTON)
{
  ...
  if (iType == 0)
  {
    ...
    cairo_rectangle(hDC->cr, (gdouble)left, (gdouble)top, (gdouble)(right - left + 1), (gdouble)(bottom - top + 1));
    cairo_fill(hDC->cr);
  }
  else
  {
