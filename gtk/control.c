/*
 * $Id: control.c 2069 2013-06-10 08:22:53Z alkresin $
 *
...
{
  gtk_notebook_remove_page((GtkNotebook *)HB_PARHANDLE(1), hb_parni(2) - 1);
}
...
{
  gtk_notebook_set_current_page((GtkNotebook *)HB_PARHANDLE(1), hb_parni(2) - 1);
}
